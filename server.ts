...
async function startServer() {
      ...
      try {
        ...
        switch (msg.type) {
          ...
          case "BUY_IDOL": {
            ...
            if (player && idol) {
              // Check if already has this idol
          ...
          case "CHANGE_PHASE": {
            ...
            if (newPhase === "VOTING") {
              ...
              // Randomly shuffle candidate groups order for 100% fair voting
          ...
          case "DEMO_FILL_SAMPLE_DATA": {
            // Pre-fill realistic idol lineups and supergroups for all 5 tycoons for quick demo
  ...
  server.listen(PORT, "0.0.0.0", () => {
    console.log(`Nhà đầu tư IDOL K-POP số 1 server running on http://0.0.0.0:${PORT}`);
  });
}
