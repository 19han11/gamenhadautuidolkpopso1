    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="text-center mb-8 relative">
        ...
        <div className="mt-5 max-w-2xl mx-auto bg-slate-900/90 border border-pink-500/30 rounded-2xl p-3 text-xs text-slate-300 flex items-center justify-center gap-2 shadow">
          ...
          <span>
            <strong>Tranh Đấu Công Khai Minh Bạch:</strong> 5 Nhà đầu tư đại diện các đế chế giải trí K-Pop cạnh tranh công khai, xây dựng nhóm nhạc đỉnh cao và nhận bình chọn trực tiếp từ khán giả!
          </span>
        </div>
      </div>
